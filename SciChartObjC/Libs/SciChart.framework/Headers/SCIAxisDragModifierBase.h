...
/**
 ...
 @endcode
 */
-(id<SCIAxis2D>) getCurrentAxis;

-(id<SCIRange>) calculateScaledRangeFrom:(CGPoint)lastPoint To:(CGPoint)currentPoint IsSecondHalf:(BOOL)isSecondHalf AtAxis:(id<SCIAxis2D>)axis;
-(SCIDoubleRange *) calculateRelativeRangeFrom:(id<SCIRange>)fromRange AtAxis:(id<SCIAxis2D>)axis;
